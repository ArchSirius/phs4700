function pcm=pcmNL(posNL)
    ...
    cm_navette_cone = [0 0 hauteur_navette_cylindre+hauteur_navette_cone/3];
    ...
    cm_reservoir_sup_cone = [0 rayon_navette+rayon_reservoir hauteur_reservoir_cylindre+hauteur_reservoir_cone/3];
    ...
    cm_propulseur_cone_x_pos = [cm_propulseur_cylindre_x_pos(1) cm_propulseur_cylindre_x_pos(2) hauteur_propulseur_cylindre+hauteur_propulseur_cone/3];
    cm_propulseur_cone_x_neg = [cm_propulseur_cylindre_x_neg(1) cm_propulseur_cylindre_x_neg(2) hauteur_propulseur_cylindre+hauteur_propulseur_cone/3];
